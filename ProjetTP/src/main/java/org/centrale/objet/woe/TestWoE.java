...
public class TestWoE {
    ...
    /* public static void main(String[] args){
         ...
         guer.saveToDatabase(database.connection, 1, 50);
         archer.saveToDatabase(database.connection, 2, 52);
         // charger de la BDN
         ...
         l.saveToDatabase(database.connection, 5, 80);
         ...
         ep.saveToDatabase(database.connection, 0, 100);
         ep.getFromDatabase(database.connection, 1, "epee100");
